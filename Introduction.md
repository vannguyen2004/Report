...
## Role
là bộ sưu tập quyền có thể là 0 haowjc nhiều người dùng
...
#Traffic Monitor: Là dịch vụ giám sác các Cache
  ...
  Traffic Monitor kiểm tra bằng cách gửi :
    ...
    Hiệu suất lưu trữ
    Hiệu suất hệ thống
    Healthy Protocol: Các máy chủ Traffic Monitorduwj phòng hoạt động độc lập với nhau nhưg khi được yêu cầu cung cấp thông tin trạng thái sức khỏe, thì chúng sẽ xem luôn các Traffic Monitor khác. Trong quá trình giám sát cache (Cache Monitoring) mỗi traffic Monitor duy nhất sẽ đánh giá trạng thái của máy chủ Cache theo quan điểm của nó.
    ...
    ếu có bốn Traffic Monitors, trong đó ba cái đánh dấu một máy chủ cache hoặc Delivery Service là không khả dụng, nhưng một cái vẫn coi nó là khả dụng, thì nó vẫn được coi là khả dụng.
...
Các xe tải giao hàng (cache servers) sẽ liên lạc với trung tâm điều hành để nhận hướng dẫn tuyến đường mới 🗺️ (cấu hình cập nhật).
...
Đối với một DNS Delivery Service, khách hàng có thể nhận được một URL như:
