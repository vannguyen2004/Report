...
### Stress test và đánh giá trước và sau khi có Nginx reverse LAMP stack ###
  **Thực hiện trên Apache JMeter**  
    + Number of Threads: 100 (Mô phỏng 100 người dùng đồng thời)  
    + Loop Count: 2 (Mỗi người dùng sẽ thực hiện 2 yêu cầu )  
    + Ramp-Up Period: 60 giây (Dàn trải việc tạo ra các thread)  
    Phân tích báo cáo hiệu năng trung bình
  ##### Trước khi có Nginx Reverse #####
    
![Screenshot_8](https://github.com/user-attachments/assets/4887eeec-fd56-44bd-98b2-f4816e161e6d)

##### Sau khi có Nginx Reverse ##### 

![Screenshot_10](https://github.com/user-attachments/assets/b56085fb-52eb-43a6-b724-85ec3dd5b390)

#### Đánh giá
+ Tốc phản hồi trung bình cao hơn khi có Nginx reverse (từ 80 -> 51) do có proxy làm đứng trung gian giữa người dùng và WEB
+ Lỗi giảm xuống từ 65% xuống % cho thấy khả năng chịu tải của Nginx cao hơn Apache
+ Dữ liệu gửi nhận tăng lên do proxy thêm head
